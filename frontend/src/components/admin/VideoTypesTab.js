...
import { videoTypeApi } from '../../services/api';
...
const VideoTypesTab = ({ isActive }) => {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      const response = await videoTypeApi.getAll(filters, limit, offset, ordering);
  ...
  return (
    <Box>
      ...
      <FormDialog
        ...
        title={`${selectedItem ? 'Edit' : 'Add'} Video Type`}
        fields={formFields}
