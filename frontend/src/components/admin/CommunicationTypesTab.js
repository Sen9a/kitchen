...
const CommunicationTypesTab = ({ isActive }) => {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      const response = await communicationApi.getAll(filters, limit, offset, ordering);
  ...
  return (
    <Box>
      ...
      <FormDialog
        ...
        title={`${selectedItem ? 'Edit' : 'Add'} Communication Type`}
        fields={formFields}
...
export default CommunicationTypesTab;
